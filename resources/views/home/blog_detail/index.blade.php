                ...
                <div class="card" style="margin-bottom: 35px;">
                    <div class="card-body">
                        <a href="javascript:void(0);" class="new_a_liyi">
                            @if(empty($blogDetail))
                                <input type="hidden" value="{{ route('addLikes', ['id' => 0]) }}" class="add">
                                <input type="hidden" value="{{ route('removeLikes', ['id' => 0]) }}" class="remove">
                            @else
                                <input type="hidden" value="{{ route('addLikes', ['id' => $blogDetail['id']]) }}" class="add">
                                <input type="hidden" value="{{ route('removeLikes', ['id' => $blogDetail['id']]) }}" class="remove">
                            @endif
